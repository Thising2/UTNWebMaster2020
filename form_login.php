...
<head>
    ...
    <title>Iniciar Sesión :: UTN Webmaster_2020</title>
</head>
...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: #e3f2fd;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link alegreya-nav-2" href="form_register.php">Registrarse</a>
            </div>
        </div>
    </nav>
    ...
    <section id="formulario" class="container-fluid bg-light">
        <div class="container">
            <h2 class="w-50 text-right">Ingresá al sitio!</h2>
                <form name="formlogin" method="POST" action="session_algorithm.php">
                        <div class="form-row">
                            <div class="col-md-9 mb-3">
                                <label for="validationDefault01">Nombre de Usuario o Email</label>
                                <input type="text" class="form-control" name="usuario" id="validationDefault01" placeholder="Ingrese aquí..." required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-9 mb-3">
                                    <label for="validationDefault02">Contraseña</label>
                                    <input type="password" class="form-control" name="clave" id="validationDefault03" placeholder="Ingrese aquí..." maxlength="15" required>
                            </div>
                        </div>
                    <div class="d-flex">
                        <button class="col-md-9 mb-3 btn btn-info font-weight-bold text-uppercase" name="ingresar" type="submit">Login</button>
                    </div>
                </form>
        </div>
    </section>
